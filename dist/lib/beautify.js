...
exports.getEditorConfigOptions = getEditorConfigOptions;
 ...
 * @returns
 */
function getBeautify(suffix) {
    const b = jsBeautify.default || jsBeautify;
    switch (suffix) {
        case "js":
        case "ts":
        case "json":
 ...
 * @returns
 */
function getEditorConfigOptions(suffix) {
 ...
 */
function beautify(content, suffix, options = {}) {
    const beautifyFunction = getBeautify(suffix);
