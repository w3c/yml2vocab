 ...
 *
 * The trick in `getBeautify`, handling the deno/node.js differences, come from Claude via the AI assistant in VSCode.
 *
 * @module
 */
...
// Mapping from suffix to configuration options
type Options = Record<string, ConfigOptions>;
 ...
 * @returns Promise for a formatted text
 */
